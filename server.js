  ...
  try {
    ...
    if (model === "doomer") {
      ...
      const response = await openai.createCompletion({
        ...
        we launched on the 19th April 2023. it was a stealth launch. the liquidity pool on uniswap is locked until 16th june 2023, which means nobody will be able
